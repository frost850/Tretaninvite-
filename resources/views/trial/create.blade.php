...
<head>
    ...
    <title>Coba Gratis — Undangan {{ $isBirthday ? 'Ulang Tahun' : 'Pernikahan' }} {{ $templateInfo['label'] }}</title>
...
<body class="min-h-screen bg-stone-100 text-stone-800 p-4 md:p-8">
    <div class="max-w-xl mx-auto">
        ...
        <div class="text-center mb-6">
            ...
            <div class="text-4xl mb-2">{{ $isBirthday ? '🎂' : '💒' }}</div>
            <h1 class="text-2xl font-bold text-stone-800">Coba Gratis 1 Hari</h1>
        ...
        <div class="bg-white rounded-2xl border border-stone-200 p-6 shadow-sm">
            ...
            <form action="{{ route('trial.store') }}" method="POST">
                @csrf
                {{-- Honeypot: disembunyikan dari pengguna, diisi otomatis oleh bot --}}
                ...
                <div class="space-y-4">
                    ...
                    @if($isBirthday)
                        {{-- Birthday fields --}}
                        <div>
                            <label class="block text-sm font-medium text-stone-700 mb-1">Nama yang Berulang Tahun <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-stone-700 mb-1">Lokasi Acara <span class="text-red-500">*</span></label>
                ...
                <div class="mt-6">
                    <button type="submit"
                            class="w-full py-3 rounded-xl {{ $isBirthday ? 'bg-pink-600 hover:bg-pink-700' : 'bg-amber-600 hover:bg-amber-700' }} text-white font-semibold text-sm transition">
