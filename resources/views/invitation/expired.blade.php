...
<head>
    ...
    <title>Masa Aktif Undangan Habis</title>
        ...
        <div class="bg-white rounded-2xl border border-stone-200 p-8 text-center shadow-sm">
            ...
            @if($wedding->isTrial())
                ...
                <p class="text-stone-500 text-sm mb-6">
                    ...
                    sudah nonaktif karena masa <strong>1 hari</strong> percobaan telah berakhir.
                </p>
            @else
                <h1 class="text-2xl font-bold text-stone-800 mb-2">Undangan Tidak Aktif</h1>
                <p class="text-stone-500 text-sm mb-6">
                    Undangan untuk
                    <strong>{{ $wedding->bride_name }}{{ $wedding->groom_name ? ' & ' . $wedding->groom_name : '' }}</strong>
                    sudah tidak aktif.
            ...
            <div class="bg-stone-50 border border-stone-200 rounded-xl p-4 mb-6 text-left text-sm text-stone-600">
                <div class="font-medium text-stone-700 mb-2">Data undangan masih tersimpan:</div>
                <ul class="space-y-1">
            ...
            <p class="text-stone-500 text-sm mb-4">Upgrade atau perpanjang untuk mengaktifkan kembali undangan ini:</p>

            <div class="grid grid-cols-2 gap-3 mb-4">
                <div class="border border-stone-200 rounded-xl p-4 text-center">
                    <div class="font-bold text-stone-800">Basic</div>
                    <div class="text-blue-600 font-bold text-xl mt-1">Rp 59.000</div>
                    <div class="text-xs text-stone-400 mt-0.5">14 hari aktif + arsip</div>
                ...
                <div class="border-2 border-amber-400 rounded-xl p-4 text-center bg-amber-50">
                    ...
                    <div class="text-amber-600 font-bold text-xl mt-1">Rp 89.000</div>
                    <div class="text-xs text-stone-400 mt-0.5">30 hari aktif + arsip</div>
                    <ul class="text-xs text-stone-500 mt-2 space-y-1 text-left">
                        <li>✅ Unlimited tamu</li>
                        <li>✅ Galeri & Musik</li>
                        <li>✅ Portal tamu online</li>
                        <li>✅ Scan QR hadir</li>
                    </ul>
                </div>
            </div>
